...
export const PlayerSchema = z.object({
  ...
  default_team_id: z.number().nullable(),
});
...
export const MatchSchema = z.object({
  ...
  home_team_roster: RosterSchema.nullable(),
  away_team: TeamSchema,
  away_team_roster: RosterSchema.nullable(),
  completed: z.boolean(),
  match_info: z.object({
...
export const ReadMatchResponseSchema = z.object({
  ...
  home_team_roster_id: z.number().nullable(),
  home_team_logo: z.string().nullable(),
  home_roster_id: z.number().nullable(),
  home_roster_name: z.string().nullable(),
  home_roster_team_id: z.number().nullable(),
  home_roster_category: z.string().nullable(),
  home_roster_player_1: PlayerId.nullable(),
  home_roster_player_2: PlayerId.nullable(),
  home_roster_player_3: PlayerId.nullable(),
  home_roster_player_4: PlayerId.nullable(),
  home_roster_player_5: PlayerId.nullable(),
  home_roster_player_6: PlayerId.nullable(),
  home_roster_player_7: PlayerId.nullable(),
  home_roster_player_8: PlayerId.nullable(),
  home_roster_player_9: PlayerId.nullable(),
  home_roster_player_10: PlayerId.nullable(),
  home_roster_player_11: PlayerId.nullable(),
  home_roster_player_12: PlayerId.nullable(),
  home_roster_player_13: PlayerId.nullable(),
  home_roster_player_14: PlayerId.nullable(),
  home_roster_player_15: PlayerId.nullable(),
  home_roster_player_16: PlayerId.nullable(),
  ...
  away_team_roster_id: z.number().nullable(),
  away_team_logo: z.string().nullable(),
  away_roster_id: z.number().nullable(),
  away_roster_name: z.string().nullable(),
  away_roster_team_id: z.number().nullable(),
  away_roster_category: z.string().nullable(),
  away_roster_player_1: PlayerId.nullable(),
  away_roster_player_2: PlayerId.nullable(),
  away_roster_player_3: PlayerId.nullable(),
  away_roster_player_4: PlayerId.nullable(),
  away_roster_player_5: PlayerId.nullable(),
  away_roster_player_6: PlayerId.nullable(),
  away_roster_player_7: PlayerId.nullable(),
  away_roster_player_8: PlayerId.nullable(),
  away_roster_player_9: PlayerId.nullable(),
  away_roster_player_10: PlayerId.nullable(),
  away_roster_player_11: PlayerId.nullable(),
  away_roster_player_12: PlayerId.nullable(),
  away_roster_player_13: PlayerId.nullable(),
  away_roster_player_14: PlayerId.nullable(),
  away_roster_player_15: PlayerId.nullable(),
  away_roster_player_16: PlayerId.nullable(),
...
export const EventSchema = z.object({
  ...
  player_1_obj: PlayerSchema.nullable().optional(),
  player_2_obj: PlayerSchema.nullable().optional(),
